...
class AddNewAccounts {
    ...
    fun login() {
        ...
        val userAuth = (service.insertaccount(createInsertAccount())
            .getOrAwaitValue() as ApiSuccessResponse).body?.data
...
//        val  actualResponse = apiHelper.getEmployeeDetails().execute()
        val actualResponse = (service.insertaccount(createInsertAccount())
            .getOrAwaitValue() as ApiSuccessResponse).body?.data.toString()
        // Assert
