...
class MobilyVoiceAdapter (private val mobilyList: List<MobilyVoiceData>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MobilyVoiceViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return MobilyVoiceViewHolder(itemView)
    }
    ...
    class MobilyVoiceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
