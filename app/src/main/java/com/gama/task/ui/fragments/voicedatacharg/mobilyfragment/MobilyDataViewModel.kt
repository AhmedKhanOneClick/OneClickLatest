...
class MobilyDataViewModel @ViewModelInject constructor(
     ...
     */
    private val _accountsList = MutableLiveData<MutableList<MobileData1>?>(ArrayList())

    /**
     * Immutable version of [_accountList].
     */
    val accountsList = _accountsList as LiveData<MutableList<MobileData1>>
...
////Get All Accounts
//    val allcontacts=generalListsRepository.getAllNotifications().apply {
//        observeForever {
//
//            if (it.data != null) {
