...
class StcAdapter (private val stcList: List<StcData>,private val onItemClickListener: OnItemClickListener):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StcViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return StcViewHolder(itemView,onItemClickListener)
    }
    ...
    class StcViewHolder(itemView: View,onItemClickListener: OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
