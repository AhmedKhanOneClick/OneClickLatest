...
class McaffeAdapter(private val mcaffeeList: List<McaffeeData>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): McaffeeViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return McaffeeViewHolder(itemView)
    }
    ...
    class McaffeeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
