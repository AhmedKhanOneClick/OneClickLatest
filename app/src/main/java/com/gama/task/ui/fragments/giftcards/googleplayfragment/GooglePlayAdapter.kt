...
class GooglePlayAdapter(private val googleplayList: List<GooglePlayData>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GooglePlayViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return GooglePlayViewHolder(itemView)
    }
    ...
    class GooglePlayViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
