...
class FifaAdapter (private val fifaList: List<FifaData>,private val onItemClickListener: OnItemClickListener):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FifaViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return FifaViewHolder(itemView,onItemClickListener)
    }
    ...
    class FifaViewHolder(itemView: View,onItemClickListener: OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
