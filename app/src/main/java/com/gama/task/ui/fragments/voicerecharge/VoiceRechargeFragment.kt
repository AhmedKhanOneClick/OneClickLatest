package com.gama.task.ui.fragments.voicerecharge
...
import com.gama.task.ui.fragments.voicerecharge.VoiceRechargeFragmentDirections
...
class VoiceRechargeFragment : Fragment(R.layout.fragment_voice_recharge) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mobily_btn.setOnClickListener{
            ...
            val action=
                VoiceRechargeFragmentDirections.actionVoiceRechargeFragmentToMobilyFragment()
        ...
        friendi_btn.setOnClickListener {
            val action=
                VoiceRechargeFragmentDirections.actionVoiceRechargeFragmentToFriendFragment()
             findNavController().navigate(action)
        }
        lebara_btn.setOnClickListener{
            val action=
                VoiceRechargeFragmentDirections.actionVoiceRechargeFragmentToLebaraFragment()
            findNavController().navigate(action)
        }
        virgin_btn.setOnClickListener {

            val action=
                VoiceRechargeFragmentDirections.actionVoiceRechargeFragmentToVirginFragment2()
            findNavController().navigate(action)
        }
