...
class LordsAdapter (private val lordsList: List<LordsData>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LordsViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return LordsViewHolder(itemView)
    }
    ...
    class LordsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
