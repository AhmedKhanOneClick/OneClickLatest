...
class AmazonAdapter(private val amazonList: List<AmazonData>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AmazonViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return AmazonViewHolder(itemView)
    }
    ...
    class AmazonViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
