...
class ZainFragment : Fragment(R.layout.fragment_data_card_zain),ZainAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        zain_rv.adapter = ZainAdapter(zainList,this)
    ...
    override fun onClick(position: Int) {
        ...
        if (!GlobalClass.globalCartList.isEmpty())
            findNavController().navigate(ZainFragmentDirections.actionZainFragmentToBottomSheetCheckOut())
    }
