...
class RazorgoldAdapter (private val razorgoldList: List<RazorgoldData>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RazorgoldViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return RazorgoldViewHolder(itemView)
    }
    ...
    class RazorgoldViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
