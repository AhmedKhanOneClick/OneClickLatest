...
class BolootAdapter (private val bolootList: List<BolootData>,private val onItemClickListener: OnItemClickListener):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BolootViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            ...
            parent, false)
        return BolootViewHolder(itemView,onItemClickListener)
    }
    ...
    class BolootViewHolder(itemView: View,onItemClickListener: OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
