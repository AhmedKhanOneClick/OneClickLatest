...
class VirginFragment : Fragment(R.layout.fragment_data_card_virgin),VirginAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        virgin_rv.adapter = VirginAdapter(virginList,this)
    ...
    override fun onClick(position: Int) {
        ...
        if (!GlobalClass.globalCartList.isEmpty())
            findNavController().navigate(VirginFragmentDirections.actionVirginFragmentToBottomSheetCheckOut())
    }
